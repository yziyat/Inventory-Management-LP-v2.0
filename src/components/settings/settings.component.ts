...
export class SettingsComponent {
  ...
  addSetting(type: 'categories' | 'destinations' | 'outgoingSubcategories') {
    let value = '';
  ...
  async deleteSetting(type: 'categories' | 'destinations' | 'outgoingSubcategories', itemToDelete: string) {
